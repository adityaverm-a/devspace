            ...
            <form className={classes.form} onSubmit={e => onSubmit(e)}>
               ...
               { displaySocials &&  <div className="socials">
                ...
                <div className="create-profile-btn">
                    <Button type='submit' variant='contained' className={classes.dashbtn} color='primary' style={{ fontFamily: ['Montserrat','sans-serif'].join(','), marginRight: 10, marginBottom:10 }}>Submit</Button>
                    <Button variant='outlined' color='primary' className={classes.dashbtn} style={{ fontFamily: ['Montserrat','sans-serif'].join(','),marginRight: 10, marginBottom:10 }} onClick={() => history.push('/dashboard')}>Go Back</Button>
                </div>
            </form>
        </div>
    )
